package com.ab.ms.customer.exceptions;
...
import com.ab.ms.customer.dto.ErrorResponseDto;
import com.ab.ms.customer.dto.InvalidDataErrorDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
            @NonNull MethodArgumentNotValidException ex, @Nullable HttpHeaders headers, @Nullable HttpStatusCode status, @Nullable WebRequest request) {
